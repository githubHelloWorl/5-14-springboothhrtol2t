...
<!-- 商品推荐 -->
<div id="animate_recommendganbuzhaopin" class="recommend animate__animated" :style='{"padding":"20px 0","margin":"0 auto","borderColor":"#ddd","background":"url(http://codegen.caihongy.cn/20230921/12de1b225a744f6a8b34b9e1979637b7.jpg),#fff","borderWidth":"1px 0","width":"100%","borderStyle":"solid","order":"3"}'>
    ...
    <div class="title" :style='{"width":"100%","margin":"30px auto","lineHeight":"50px","textAlign":"center","background":"none"}'>
		<span :style='{"color":"#333","fontSize":"32px","lineHeight":"40px"}'>社团招聘推荐</span>
	</div>
	...
	<div class="list list1 index-pv1" :style='{"padding":"0 7%","flexWrap":"wrap","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
		<div :style='{"cursor":"pointer","padding":"0 0 10px","boxShadow":"0px 26px 26px -30px #999","margin":"0 0 30px","background":"#f5f5f5","display":"inline-block","width":"18%","position":"relative","height":"auto"}' v-for="(item,index) in ganbuzhaopinRecommend" :key="index" @click="toDetail('ganbuzhaopinDetail', item)" class="list-item animation-box">

			<img :style='{"width":"100%","objectFit":"cover","display":"block","height":"240px"}' v-if="preHttp(item.zhaopinfengmian)" :src="item.zhaopinfengmian.split(',')[0]" alt="" />
			<img :style='{"width":"100%","objectFit":"cover","display":"block","height":"240px"}' v-else :src="baseUrl + (item.zhaopinfengmian?item.zhaopinfengmian.split(',')[0]:'')" alt="" />
			<div class="name line1" :style='{"padding":"0 10px","overflow":"hidden","whiteSpace":"nowrap","color":"#333","width":"100%","lineHeight":"30px","fontSize":"14px","textOverflow":"ellipsis"}'>{{item.gangweimingcheng}}</div>
	...
	<div @click="moreBtn('ganbuzhaopin')" :style='{"border":"1px solid #ddd","cursor":"pointer","margin":"20px auto","textAlign":"center","background":"#fff","display":"block","width":"120px","lineHeight":"36px"}'>
		<span :style='{"color":"#333","fontSize":"14px"}'>查看更多</span>
...
<!-- 商品推荐 -->
<div id="animate_recommendhuodongxinxi" class="recommend animate__animated" :style='{"padding":"20px 0","margin":"0 auto","borderColor":"#ddd","background":"url(http://codegen.caihongy.cn/20230921/12de1b225a744f6a8b34b9e1979637b7.jpg),#fff","borderWidth":"1px 0","width":"100%","borderStyle":"solid","order":"3"}'>
	<div v-if="false" class="idea recommendIdea" :style='{"padding":"20px","flexWrap":"wrap","background":"#efefef","justifyContent":"space-between","display":"flex"}'>
		<div class="box1" :style='{"width":"20%","background":"#fff","height":"80px"}'></div>
		<div class="box2" :style='{"width":"20%","background":"#fff","height":"80px"}'></div>
		<div class="box3" :style='{"width":"20%","background":"#fff","height":"80px"}'></div>
    ...
    <div class="title" :style='{"width":"100%","margin":"30px auto","lineHeight":"50px","textAlign":"center","background":"none"}'>
		<span :style='{"color":"#333","fontSize":"32px","lineHeight":"40px"}'>活动信息推荐</span>
	</div>
	
	
	<!-- 样式一 -->
	<div class="list list1 index-pv1" :style='{"padding":"0 7%","flexWrap":"wrap","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
		<div :style='{"cursor":"pointer","padding":"0 0 10px","boxShadow":"0px 26px 26px -30px #999","margin":"0 0 30px","background":"#f5f5f5","display":"inline-block","width":"18%","position":"relative","height":"auto"}' v-for="(item,index) in huodongxinxiRecommend" :key="index" @click="toDetail('huodongxinxiDetail', item)" class="list-item animation-box">

			<img :style='{"width":"100%","objectFit":"cover","display":"block","height":"240px"}' v-if="preHttp(item.huodongzhaopian)" :src="item.huodongzhaopian.split(',')[0]" alt="" />
			<img :style='{"width":"100%","objectFit":"cover","display":"block","height":"240px"}' v-else :src="baseUrl + (item.huodongzhaopian?item.huodongzhaopian.split(',')[0]:'')" alt="" />
			<div class="name line1" :style='{"padding":"0 10px","overflow":"hidden","whiteSpace":"nowrap","color":"#333","width":"100%","lineHeight":"30px","fontSize":"14px","textOverflow":"ellipsis"}'>{{item.huodongmingcheng}}</div>
			<div :style='{"width":"100%","padding":"0 10px","display":"inline-block"}'>
			  <span class="icon iconfont icon-shijian21" :style='{"margin":"0 2px 0 0","lineHeight":"1.5","fontSize":"12px","color":"#666"}'></span>
			  <span class="text" :style='{"color":"#666","lineHeight":"1.5","fontSize":"12px"}'>{{item.addtime}}</span>
			</div>
	...
	<div @click="moreBtn('huodongxinxi')" :style='{"border":"1px solid #ddd","cursor":"pointer","margin":"20px auto","textAlign":"center","background":"#fff","display":"block","width":"120px","lineHeight":"36px"}'>
		<span :style='{"color":"#333","fontSize":"14px"}'>查看更多</span>
		<i :style='{"color":"#333","fontSize":"14px"}' class="icon iconfont icon-gengduo1"></i>
	</div>
...
<!-- 特价商品 -->
<div id="animate_listyouxiuxiaoyouqiang" class="lists animate__animated" :style='{"margin":"30px 0 20px","background":"#fff","order":"1"}'>
	...
	<div class="title" :style='{"width":"100%","margin":"10px auto","lineHeight":"40px","textAlign":"center","background":"none"}'>
	  <span :style='{"fontSize":"32px","lineHeight":"40px","color":"#333","font":"\"宋体\""}'>优秀校友墙展示</span>
	</div>
	...
	<div v-if="youxiuxiaoyouqiangList.length" class="list list12 index-pv1 list12youxiuxiaoyouqiang" :style='{"width":"100%","padding":"10px 7%","background":"#fff","height":"auto"}'>
	  <div class="list" :style='{"margin":"40px 0 0","overflow":"hidden","flexWrap":"wrap","flex":"1","background":"#fff","display":"flex","justifyContent":"space-between","height":"auto"}'>
	    <div :style='{"cursor":"pointer","width":"23%","margin":"0 0 30px","position":"relative","height":"auto"}' class="item list-item animation-box" v-for="item,index in youxiuxiaoyouqiangList" :key="index" @click="toDetail('youxiuxiaoyouqiangDetail', item)">
			...
			<div class="line1" :style='{"padding":"0 10px","overflow":"hidden","whiteSpace":"nowrap","color":"#333","width":"100%","lineHeight":"32px","fontSize":"16px","textOverflow":"ellipsis"}'>{{item.yonghuxingming}}</div>
	    </div>
	  </div>
	</div>
	...
	<div @click="moreBtn('youxiuxiaoyouqiang')" :style='{"border":"1px solid #ddd","cursor":"pointer","margin":"30px auto 10px","textAlign":"center","background":"#fff","display":"block","width":"120px","lineHeight":"36px"}'>
		<span :style='{"color":"#333","fontSize":"14px"}'>查看更多</span>
  ...
  export default {
    ...
    data() {
      return {
        ...
        newsList: [],
        ganbuzhaopinRecommend: [],
        huodongxinxiRecommend: [],

        youxiuxiaoyouqiangList: [],
    ...
    methods: {
		...
		handleScroll() {
			let arr = [
				...
				{id:'animate_recommendganbuzhaopin',css:'animate__fadeInLeft'},
				{id:'animate_recommendhuodongxinxi',css:'animate__fadeInLeft'},
				{id:'animate_listyouxiuxiaoyouqiang',css:'animate__fadeInLeft'},
      ...
      getSystemIntroduction() {
		...
		getList() {
			let autoSortUrl = "";
			let data = {}
          autoSortUrl = "ganbuzhaopin/autoSort";
			data = {
				page: 1,
				limit: 15,
			}
			this.$http.get(autoSortUrl, {params: data}).then(res => {
				if (res.data.code == 0) {
					this.ganbuzhaopinRecommend = res.data.data.list;
          ...
          autoSortUrl = "huodongxinxi/autoSort";
			...
			this.$http.get('youxiuxiaoyouqiang/list', {params: data}).then(res => {
				if (res.data.code == 0) {
					this.youxiuxiaoyouqiangList = res.data.data.list;
