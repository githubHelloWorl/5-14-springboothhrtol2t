...
<style lang="scss" scoped>
	...
	.scrollbar-wrapper-open .el-menu-vertical-2>.el-menu-item.other>.el-tooltip {
				...
				color: #fff;
				white-space: nowrap;
				background: url(http://codegen.caihongy.cn/20240322/e2228cedbb0f48d7946fd7b4ccb2a8c0.png) no-repeat center bottom;
				font-size: 14px;
				line-height: 1.2;
				position: relative;
				height: auto;
	...
	.scrollbar-wrapper-open .el-menu-vertical-2>.el-menu-item.other>.el-tooltip:hover {
				color: #fff !important;
				background: url(http://codegen.caihongy.cn/20240322/e2228cedbb0f48d7946fd7b4ccb2a8c0.png) no-repeat center bottom !important;
			}
