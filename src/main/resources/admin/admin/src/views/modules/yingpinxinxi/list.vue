		...
		<template v-if="showFlag">
			...
			<div :style='{"border":"0px solid #eee","width":"100%","padding":"0","margin":"0px 0 0","borderRadius":"12px","background":"rgba(255,255,255,.9)"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column :resizable='true' :sortable='true' prop="jianli" label="简历">
						<template slot-scope="scope">
							<el-button v-if="scope.row.jianli" type="text" size="small" @click="download(scope.row.jianli)">下载</el-button>
                            <span v-else >无</span>
						</template>
					</el-table-column>
					<el-table-column :resizable='true' :sortable='true'  
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button class="edit" v-if=" isAuth('yingpinxinxi','修改') " type="success" @click="addOrUpdateHandler(scope.row.id)">
