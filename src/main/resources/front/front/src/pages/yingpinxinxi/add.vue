...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="应聘时间" prop="yingpinshijian">
              <el-date-picker
				  :disabled=" false  ||ro.yingpinshijian"
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="简历" prop="jianli">
            <file-upload
            tip="点击上传简历"
            action="file/upload"
            :limit="1"
